...
// it should return size of all class datatypes but thats not the case
// our os reads the data by dividing into segments and for each segment the next data goes to another memory segment thats why
